...
class CalculationCore:
    def __init__(
        ...
        *,
        ...
        secret_policy: SecretPersistencePolicy | None = None,
        ...
        self.secrets_resolver = (
            ...
            else _secrets_resolver_from_runtime(runtime, secret_policy=secret_policy, secret_store=secret_store)
        )
...
def _secrets_resolver_from_runtime(
    runtime: RuntimeCapabilities | None,
    *,
    secret_policy: SecretPersistencePolicy | None = None,
    secret_store: SecretStore | None = None,
) -> SecretsResolver:
    return RuntimeSecretsResolver.from_runtime(runtime, policy=secret_policy, store=secret_store)
