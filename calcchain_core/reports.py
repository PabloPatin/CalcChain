...
from calcchain_core.plugin_runtime import ReportContext, ReportDescriptor, ReportRequest, ReportResult
from calcchain_core.plugins.diagnostics import redact_secrets
...
class ReportRegistry:
    ...
    def from_runtime(cls, runtime: PluginRuntimeSet | None) -> ReportRegistry:
        ...
        for key, record in runtime.capabilities.items():
            ...
            entries[key.id] = RegisteredReportCapability(record.capability, plugin_id=record.owner)
        return cls(entries)
